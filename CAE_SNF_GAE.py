...
survive = pd.read_csv('data/BRCA/down_survive.csv', sep=',').set_index('Unnamed: 0')
RNA = pd.read_csv('data/BRCA/RNA.csv', sep=',').set_index('Unnamed: 0')
CNV = pd.read_csv('data/BRCA/CNV.csv', sep=',').set_index('Unnamed: 0')
SNV = pd.read_csv('data/BRCA/SNV.csv', sep=',').set_index('Unnamed: 0')
MIRNA = pd.read_csv('data/BRCA/MIRNA.csv', sep=',').set_index('Unnamed: 0')
clinical = pd.read_csv('data/BRCA/down_clinical.csv', sep=',', index_col=0)
...
SURVIVE_SELECT.to_csv('data/BRCA/CAE_SNF_GAE/SURVIVE_SELECT.csv', index=True, header=True)

# Save individual CAE features
pd.DataFrame(CNV_feature, index=survive.index).to_csv('data/BRCA/CAE_SNF_GAE/CNV_CAE100.csv', index=True, header=True)
pd.DataFrame(RNA_feature, index=survive.index).to_csv('data/BRCA/CAE_SNF_GAE/RNA_CAE100.csv', index=True, header=True)
pd.DataFrame(MIRNA_feature, index=survive.index).to_csv('data/BRCA/CAE_SNF_GAE/MIRNA_CAE100.csv', index=True, header=True)
pd.DataFrame(SNV_feature, index=survive.index).to_csv('data/BRCA/CAE_SNF_GAE/SNV_CAE100.csv', index=True, header=True)

# Load saved features
rna_data = pd.read_csv('data/BRCA/CAE_SNF_GAE/RNA_CAE100.csv', sep=',').set_index('Unnamed: 0')
cnv_data = pd.read_csv('data/BRCA/CAE_SNF_GAE/CNV_CAE100.csv', sep=',').set_index('Unnamed: 0')
snv_data = pd.read_csv('data/BRCA/CAE_SNF_GAE/SNV_CAE100.csv', sep=',').set_index('Unnamed: 0')
mirna_data = pd.read_csv('data/BRCA/CAE_SNF_GAE/MIRNA_CAE100.csv', sep=',').set_index('Unnamed: 0')
...
fused_df.to_csv('data/BRCA/CAE_SNF_GAE/SNF400.csv', header=True, index=True)

# Load fused SNF graph and selected features
affinity_df_snf = pd.read_csv('data/BRCA/CAE_SNF_GAE/SNF400.csv', sep=',', index_col=0)
features_df = pd.read_csv('data/BRCA/CAE_SNF_GAE/SURVIVE_SELECT.csv', sep=',', index_col=0)
...
final_adjacency_df.to_csv('data/BRCA/CAE_SNF_GAE/GAE_adjacency.csv', header=True, index=True)
...
binary_adjacency_df.to_csv('data/BRCA/CAE_SNF_GAE/GAE0.95.csv')